...
with graph.as_default():
    ...
    Generator_optimizer     = tf.train.AdamOptimizer().minimize(Generator_loss,     var_list = Generator_variables)
    Discriminator_optimizer = tf.train.AdamOptimizer().minimize(Discriminator_loss, var_list = Discriminator_variables)
